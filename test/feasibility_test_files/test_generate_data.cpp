...
//   int N_positive_data_to_generate = 10000;
...
int main(int argc, char ** argv){
	...
	if (argc > 5){
		...
		std::cout << "Expected 4 arguments: N(int) yaml_filename(string), visualize(bool) generate_positive_data_only(bool)"
	...
	// test_generate_and_visualize_N_contact_transition_data(argc, argv, N, yaml_filename);
