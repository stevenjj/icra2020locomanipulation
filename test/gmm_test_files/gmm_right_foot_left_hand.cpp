...
int main(int argc, char ** argv){
  ...
  out1 << YAML::EndMap;
  char filename1[64];
  snprintf(filename1, sizeof(char)*64, "/home/mihir/lMD/R/good/rflh/norm.yaml");
  ...
  char filename[64];
  // filename = "file.yaml"
  snprintf(filename, sizeof(char)*64, "/home/mihir/lMD/R/good/rflh/gmm%d.yaml", i);
  ...
  out << YAML::EndMap;
  std::ofstream file_output_stream("/home/mihir/lMD/R/good/rflh/dataminmax.yaml");
  file_output_stream << out.c_str();
}
