...
// Constructor
RvizTranslator::RvizTranslator(){}
// Destructor
RvizTranslator::~RvizTranslator(){}

void RvizTranslator::populate_joint_state_msg(const pinocchio::Model & model,
...
int RvizTranslator::getJointId(const pinocchio::Model & model, const std::string & name){
