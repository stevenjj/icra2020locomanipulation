#ifndef ALM_6DPOSE_NO_ZRXRY_TASK_H
#define ALM_6DPOSE_NO_ZRXRY_TASK_H

#include <avatar_locomanipulation/tasks/task.hpp>

class Task6DPoseNoRXRY: public Task{
public:
	Task6DPoseNoRXRY(std::shared_ptr<RobotModel> & input_model, const std::string & input_frame_name);

	virtual ~Task6DPoseNoRXRY();
