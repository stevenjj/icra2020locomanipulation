#ifndef ALM_LKNEE_SELFCOLLISION_TASK_H
#define ALM_LKNEE_SELFCOLLISION_TASK_H
...
class TaskLkneeSelfCollision: public Task{
public:
	TaskLkneeSelfCollision(std::shared_ptr<RobotModel> & input_model, const std::string & input_frame_name, std::shared_ptr<CollisionEnvironment> & collision);

	virtual ~TaskLkneeSelfCollision();
