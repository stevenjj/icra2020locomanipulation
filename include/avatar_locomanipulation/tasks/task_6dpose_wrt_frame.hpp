#ifndef ALM_6DPOSE_WRT_FRAME_TASK_H
#define ALM_6DPOSE_WRT_FRAME_TASK_H

#include <avatar_locomanipulation/tasks/task_6dpose.hpp>
#include <avatar_locomanipulation/data_types/footstep.hpp>

class Task6DPosewrtFrame: public Task6DPose{
public:
	Task6DPosewrtFrame(std::shared_ptr<RobotModel> & input_model, 
					   const std::string & input_frame_name, 
					   const std::string & input_wrt_frame_name);
	virtual ~Task6DPosewrtFrame();
