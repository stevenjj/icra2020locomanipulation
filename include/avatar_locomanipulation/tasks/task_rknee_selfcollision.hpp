#ifndef ALM_RKNEE_SELFCOLLISION_TASK_H
#define ALM_RKNEE_SELFCOLLISION_TASK_H
...
class TaskRkneeSelfCollision: public Task{
public:
	TaskRkneeSelfCollision(std::shared_ptr<RobotModel> & input_model, const std::string & input_frame_name, std::shared_ptr<CollisionEnvironment> & collision);

	virtual ~TaskRkneeSelfCollision();
